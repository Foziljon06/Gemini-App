...
import 'package:geminigetx/domain/entities/gemini_talk_entity.dart';

GeminiTalkModel geminiTalkResFromJson(String str) => GeminiTalkModel.fromJson(json.decode(str));
...
class CandidateModel extends CandidateEntity {
  CandidateModel({required super.content, required super.finishReason, required super.index, required super.safetyRatings});
  factory CandidateModel.fromJson(Map<String, dynamic> json) => CandidateModel(
    content: ContentModel.fromJson(json["content"]),
    finishReason: json["finishReason"],
    index: json["index"],
    safetyRatings: List<SafetyRatingModel>.from(json["safetyRatings"].map((x) => SafetyRatingModel.fromJson(x))),
  );
  Map<String, dynamic> toJson() => {
    "content": content,
...
class SafetyRatingModel extends SafetyRatingEntity {
  ...
  factory SafetyRatingModel.fromJson(Map<String, dynamic> json) => SafetyRatingModel(
...
class UsageMetadataModel extends UsageMetadataEntity {
  UsageMetadataModel({required super.promptTokenCount, required super.candidatesTokenCount, required super.totalTokenCount});
